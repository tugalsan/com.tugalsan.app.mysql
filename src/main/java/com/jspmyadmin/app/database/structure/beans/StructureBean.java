...
public class StructureBean extends Bean {
    ...
    /**
     * @param column_length the column_length to set
     */
    ...
    /**
     * @param enable_checks the enable_checks to set
     */
    ...
    /**
     * @param drop_checks the drop_checks to set
     */
    ...
    /**
     * @param new_prefix the new_prefix to set
     */
